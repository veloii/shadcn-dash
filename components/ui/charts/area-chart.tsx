...
const areaColors: Record<Color, { dot: string; className: string }> = {
  ...
  orange: {
    dot: "fill-orange-500",
    className: "fill-orange-500/5 stroke-orange-500",
  },
  amber: {
    dot: "fill-amber-500",
  ...
  yellow: {
    dot: "fill-yellow-500",
    className: "fill-yellow-500/5 stroke-yellow-500",
  },
  lime: {
    dot: "fill-lime-500",
    className: "fill-lime-500/5 stroke-lime-500",
  },
  green: {
    dot: "fill-green-500",
    className: "fill-green-500/5 stroke-green-500",
  },
  emerald: {
  ...
  teal: {
    dot: "fill-teal-500",
    className: "fill-teal-500/5 stroke-teal-500",
  },
  cyan: {
    dot: "fill-cyan-500",
    className: "fill-cyan-500/5 stroke-cyan-500",
  },
  sky: {
    dot: "fill-sky-500",
  ...
  indigo: {
    dot: "fill-indigo-500",
    className: "fill-indigo-500/5 stroke-indigo-500",
  },
  violet: {
    dot: "fill-violet-500",
    className: "fill-violet-500/5 stroke-violet-500",
  },
  purple: {
    dot: "fill-purple-500",
    className: "fill-purple-500/5 stroke-purple-500",
  },
  fuchsia: {
    dot: "fill-fuchsia-500",
    className: "fill-fuchsia-500/5 stroke-fuchsia-500",
  },
  pink: {
    dot: "fill-pink-500",
    className: "fill-pink-500/5 stroke-pink-500",
  },
  rose: {
    dot: "fill-rose-500",
