 ...
 */
export function createStoreContext<TState, TCreateStoreArgs extends {}>(createStore: (props: TCreateStoreArgs) => UseBoundStore<StoreApi<TState>>) {
   ...
   */
  const StoreProvider: React.FC<StoreProviderProps> = ({ children, ...args }) => {
